    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            foreach ( var user in userList) 
            {
                ...
                else
                {
                    ...
                    user.Role = roleList.FirstOrDefault(r => r.Id == user.RoleId).Name;
                }
            }
        ...
        public async Task<IActionResult> Edit(ApplicationUser user)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData[Constants.Notification.Success] = "User has been edited successfully.";
        ...
        public IActionResult LockUnlock(string userId)
        {
            ...
            if (objFromDb.LockoutEnd != null && objFromDb.LockoutEnd > DateTime.Now)
            {
                ...
                TempData[Constants.Notification.Success] = "User unlocked successfully.";
            }
            else
            {
                //user is not locked, and we want to lock the user
                objFromDb.LockoutEnd = DateTime.Now.AddDays(30);
                TempData[Constants.Notification.Success] = "User locked successfully.";
            }
        ...
        public IActionResult Delete(string userId)
        {
            ...
            TempData[Constants.Notification.Success] = "User deleted successfully.";
        ...
        public async Task<IActionResult> ManageUserClaims(UserClaimsVm userClaimsVm)
        {
            ...
            if (!result.Succeeded)
            {
                TempData[Constants.Notification.Error] = "Error while removing claims";
            ...
            if (!result.Succeeded)
            {
                TempData[Constants.Notification.Error] = "Error while adding claims";
                return View(userClaimsVm);
            }

            TempData[Constants.Notification.Success] = "Claims updated successfully";
